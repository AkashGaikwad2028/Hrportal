          ...
          <View style={[GLOBALSTYLE.columnView]}>
            ...
            <View style={[GLOBALSTYLE.columnView]}>
              <View
                ...
                <View style={{flexDirection: 'column', marginTop: 10,marginHorizontal:8}}>
                  <Text
                    style={[
                      GLOBALSTYLE.text,
                  ...
                  <View style={[styles.CheckBox1,{backgroundColor:item.payment===1 ?"#ffff00":"white"}]}>
                  <Image source={require("../../../Components/tick.png")} style={{width:30}} />
                  </View>
                </View>
                <View style={{flexDirection: 'column', marginTop: 10,marginHorizontal:8}}>
                  <Text
                  ...
                  <View style={[styles.CheckBox1,{backgroundColor:item.invoice===1 ?"#ffff00":"white"}]}>
                  <Image source={require("../../../Components/tick.png")} style={{width:30}} />
                  </View>
                </View>
                <View style={{flexDirection: 'column', marginTop: 10,marginHorizontal:8}}>
                  ...
                  <View style={[styles.CheckBox1,{backgroundColor:item.hard_copy===1 ?"#ffff00":"white"}]}>
                  <Image source={require("../../../Components/tick.png")} style={{width:30}} />
                  </View>
                </View>
                <View style={{flexDirection: 'column', marginTop: 10,marginHorizontal:8}}>
                  ...
                  <View style={[styles.CheckBox1,{backgroundColor:item.pf===1 ?"#ffff00":"white"}]}>
                  <Image source={require("../../../Components/tick.png")} style={{width:30}} />
                  </View>
                </View>
                <View style={{flexDirection: 'column', marginTop: 10,marginHorizontal:8}}>
                  ...
                  <View style={[styles.CheckBox1,{backgroundColor:item.timesheet===1 ?"#ffff00":"white"}]}>
                  <Image source={require("../../../Components/tick.png")} style={{width:30}} />
                  </View>
                </View>
              </View>
