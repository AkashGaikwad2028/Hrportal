...
export const GetExternalInvoiceHistory=()=>{
    ...
    return async dispatch=>{
        dispatch(EXTERNALInvoiceHistory({isLoading:true},EXTERNALINVOICEHISTORY_PROGRESS,))
        try{
            ...
            dispatch(EXTERNALInvoiceHistory(res.data,EXTERNALINVOICEHISTORY_SUCCESS,))
        }
        catch (error){
...
export function getExternalInvoiceMonthlyData(MonthData) {
    ...
    return async dispatch => {
        ...
        dispatch(EXTERNALInvoiceHistory({}, EXTERNALINVOICEHISTORYMONTHDATA_PROGRESS))
        ...
        try {
            ...
            console.log('EXTERNALINVOICEHISTORYMONTHDATA response=>>>>>>>>>>>>>>', data.data.data);
            dispatch(EXTERNALInvoiceHistory(data.data.data, EXTERNALINVOICEHISTORYMONTHDATA_SUCCESS,))

        } catch (err) {
            console.log('EXTERNALINVOICEHISTORYMONTHDATA error', err);
            dispatch(EXTERNALInvoiceHistory(err, EXTERNALINVOICEHISTORYMONTHDATA_FAIL));
