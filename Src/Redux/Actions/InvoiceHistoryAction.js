...
export function SendInvoiceHistoryData(data) {
    ...
    export function GetInvoiceHistoryDataMonthlySearchData(getyearvalue,getMonthvalue,searchValue) {
        console.log(" called GetInvoiceHistoryDataMonthlySearchData data=>>>>>>>>>>>>>>>>>>>>>>>>", getyearvalue,getMonthvalue,searchValue)
        const year=getyearvalue
        const month = getMonthvalue
        ...
        return async dispatch => {
            ...
            try {
                ...
                console.log('GetInvoiceHistoryDataMonthlySearchData search response=>>>>>>>>>>>>>>',  data.data);
                dispatch(InvoiceHistory( data.data, INVOICEHISTORYHISTORYMONTHSEARCHDATA_SUCCESS,))
